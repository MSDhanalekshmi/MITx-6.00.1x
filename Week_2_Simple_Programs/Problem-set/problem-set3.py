...
# we can pay off the entire balance within a year. What is a reasonable lower bound for this
# payment value? $0 is the obvious answer, but you can do better than that. If there was no interest,
...
#  off each month. So a good upper bound for the monthly payment would be one-twelfth of the balance,
...
#  the Wikipedia page on bisection search) to find the smallest monthly payment to the cent
#  (no more multiples of $10) such that we can pay off the debt within a year.
#  Try it out with large inputs, and notice how fast it is (try the same large inputs in your
